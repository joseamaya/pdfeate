    ...
    return (
      <div className="file-row status-completed">
        ...
        <div className="reset-container">
          <button className="btn-reset" onClick={handleReset}>Desbloquear otro PDF</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="upload-section">
      ...
      >
        ...
        <p className="drop-text">Arrastra un PDF protegido aquí o haz clic para seleccionarlo</p>
      </div>
        ...
        <div className="file-preview">
          ...
          <div className="compress-options">
            <div className="compress-option">
              <label className="compress-label" htmlFor="unlock-pass">Contraseña del PDF</label>
              <input
                id="unlock-pass"
                type="password"
          ...
          <button className="btn-upload" onClick={handleSubmit} disabled={loading || !password}>
